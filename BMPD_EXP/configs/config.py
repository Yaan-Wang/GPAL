...
"""Data Dir"""
C.data_root_path = os.path.join(C.root_dir,'dataset','BMPD') 
...
C.image_size = 512
C.scale_list = [1., 1.25, 1.5]  # [.5, .75, 1., 1.25, 1.5] #
C.ignore_index = 255
...
C.sam_b.image_embedding_size = int(C.image_size/16)
...
C.sam_l.image_embedding_size = int(C.image_size/16)
...
C.sam_h.image_embedding_size = int(C.image_size/16)
