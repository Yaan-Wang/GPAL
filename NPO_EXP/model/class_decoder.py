...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        b, q, c, h, w = src.shape
        dense_prompt_embeddings=einops.rearrange(dense_prompt_embeddings, '(b q) c h w -> b q c h w',q=3)
        ...
        # print("semantic_masks",semantic_masks.shape)
        # print("sailency_masks",sailency_masks.shape)
